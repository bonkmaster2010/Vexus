export const CALSubLinks = {
  ...
  monitor: [
    { title: "Gaming Monitors", id: "pcmcat748300502074", route: "monitors" },
    { title: "4K Monitors", id: "pcmcat748300502075", route: "monitors" },
    { title: "Ultrawide Monitors", id: "pcmcat748300502073", route: "monitors" },
    { title: "Curved Monitors", id: "pcmcat748300502072", route: "monitors" },
    { title: "Pro Monitors", id: "pcmcat748300502071", route: "monitors" }
  ],
...
export const MTSubLinks = {
  tablet: [
    { title: "Apple", id: "Apple", route: "tablets" },
    { title: "Samsung", id: "Samsung", route: "tablets" },
    { title: "Lenovo", id: "Lenovo", route: "tablets" },
    { title: "Microsoft", id: "Microsoft", route: "tablets" },
    { title: "Amazon", id: "Amazon", route: "tablets" }
  ],

  mobile: [
    { title: "Apple", id: "Apple", route: "mobiles" },
    { title: "Samsung", id: "Samsung", route: "mobiles" },
    { title: "Google", id: "Google", route: "mobiles" },
    { title: "OnePlus", id: "OnePlus", route: "mobiles" },
    { title: "Motorola", id: "Motorola", route: "mobiles" },
    { title: "Xiaomi", id: "Xiaomi", route: "mobiles" }
  ],

  smartwatch: [
    { title: "Apple", id: "Apple", route: "smartwatches" },
    { title: "Samsung", id: "Samsung", route: "smartwatches" },
    { title: "Fitbit", id: "Fitbit", route: "smartwatches" },
    { title: "Garmin", id: "Garmin", route: "smartwatches" },
    { title: "Fossil", id: "Fossil", route: "smartwatches" },
    { title: "Google", id: "Google", route: "smartwatches" }
  ],
